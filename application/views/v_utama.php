...
<body>
        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item <?php echo ($current_uri == '') ? 'active' : ''; ?>" id="dashboard">
                    ...
                    <li class="sidebar-item " id="prospek">
                        <a href="#" class='sidebar-link'>
                    ...
                    <li class="sidebar-item " id="video_promosi">
                        <a href="#" class='sidebar-link'>
    ...
    <script>
        $(function(){
        // START READY
            let cek = '<?php echo $title ?>';
            console.log(cek);
            if(cek == 'Dashboard'){
                $('#isi').load('index.php/admin2/prospek');
            }
            $('#dashboard').click(function() {
                    $('.sidebar-item').removeClass('active');
                    $(this).addClass('active');
                    window.history.pushState("html", "Title", "<?php echo base_url(); ?>");
                    // document.title = 'CRM -Dashboard';
                    $('#isi').empty().load('index.php/admin2/dashboard');
            });
            $('#prospek').click(function() {
                    $('.sidebar-item').removeClass('active');
                    $(this).addClass('active');
                    window.history.pushState("html", "Title", "<?php echo base_url(); ?>");
                    document.title = 'CRM -Prospek';
                    $('#isi').empty().load('index.php/admin2/prospek');
            });
            $('#customer').click(function() {
                    $('.sidebar-item').removeClass('active');
                    $(this).addClass('active');
                    document.title = 'CRM -Customer';
                    $('#isi').empty().load('index.php/admin2/customer');
            });
            $('#agen').click(function() {
                    $('.sidebar-item').removeClass('active');
                    $(this).addClass('active');
                    document.title = 'CRM -Agen';
                    $('#isi').empty().load('index.php/admin2/agen');
            });
            $('#video_promosi').click(function() {
                    $('.sidebar-item').removeClass('active');
                    $(this).addClass('active');
                    document.title = 'CRM -Video Promosi';
                    $('#isi').empty().load('index.php/admin2/video_promosi');
            });
